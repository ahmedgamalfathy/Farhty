...
<div class="container pt-5">
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            <form class="add-new-user" id="addNewUserForm" action="{{ route('condition.update', ['id'=> $cond->id]) }}" method="POST"  >
                @csrf
                <div class="row ">
                    ...
                    <div class="col-12">
                        ...
                        id="add-user-fullname"
                         placeholder="اضف نص"
                         rows="10"
                         name="terms_conditions" >{{ $cond->terms_conditions }} </textarea>
                ...
                <div class="d-flex justify-content-end mt-4">
                    ...
                    <a href="{{ route('condition') }}" class="btn btn-danger">تراجع</a>
                </div>
            </form>
        </div>
    </div>
